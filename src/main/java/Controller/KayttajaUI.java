...
public class KayttajaUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //lista resurseista
        //Resurssit resurssi = new Resurssit(7, "nimi", "tyypi", 0, "kuvaus");
        //ObservableList<Model.Resurssit> data = FXCollections.observableArrayList(
        //        resurssi,resurssi);
        
        TableView<Model.Resurssit> table = new TableView<Model.Resurssit>();
        ...
        //table.setItems(data);
        final TableRow cell = new TableRow();
